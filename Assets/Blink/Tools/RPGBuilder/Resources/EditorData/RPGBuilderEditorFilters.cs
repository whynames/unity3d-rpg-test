...
public class RPGBuilderEditorFilters : ScriptableObject
{
    ...
    public List<FilterEntryData> pointFilters = new List<FilterEntryData>();
    ...
    public List<FilterEntryData> levelsFilters = new List<FilterEntryData>();
    ...
    public List<FilterEntryData> coordinateFilters = new List<FilterEntryData>();
    public List<FilterEntryData> resourceFilters = new List<FilterEntryData>();
    ...
    public class GeneralSettingsModuleSection
    {
        ...
        public bool showTimeSettings;
    }

    public GeneralSettingsModuleSection generalSettingsModuleSection = new GeneralSettingsModuleSection();
    
    [Serializable]
    public class PersistenceSettingsModuleSection
    {
        public bool showPersistenceUtility;
        public bool showSpawnedPersistentPrefabs;
    }

    public PersistenceSettingsModuleSection persistenceSettingsModuleSection = new PersistenceSettingsModuleSection();
    ...
    public GameUISettingsModuleSection gameUISettingsModuleSection = new GameUISettingsModuleSection();
    
    [Serializable]
    public class UpgradeUtilityModuleSection
    {
        public bool showDatabaseUpgrade;
        public bool showIDFilesUpgrade;
        public bool showSettingsUpgrade;
        public bool showConvertSettingLists;
        public bool showAssignTypeEntries;
        public bool showCreateVisualEffectTemplates;
        public bool showCreateAnimationTemplates;
        public bool showCreateNPCPresets;
    }

    public UpgradeUtilityModuleSection upgradeUtilityModuleSection = new UpgradeUtilityModuleSection();
    
    [Serializable]
    public class ExportDatabaseModuleSection
    {
        public bool showExportDatabase;
    }

    public ExportDatabaseModuleSection exportDatabaseModuleSection = new ExportDatabaseModuleSection();
}
