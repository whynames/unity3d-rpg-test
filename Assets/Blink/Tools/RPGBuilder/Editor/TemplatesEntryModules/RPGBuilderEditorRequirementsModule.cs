...
public class RPGBuilderEditorRequirementsModule : RPGBuilderEditorModule
{
    private Dictionary<int, RequirementsTemplate> entries = new Dictionary<int, RequirementsTemplate>();
    private RequirementsTemplate currentEntry;
    ...
    {
        Dictionary<int, RequirementsTemplate> dictionary = new Dictionary<int, RequirementsTemplate>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RequirementsTemplate>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                                    AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RequirementsTemplate>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    public override bool SaveConditionsMet()
    {
        ...
        {
            RPGBuilderEditorUtility.DisplayDialogueWindow("Invalid Characters", "The Name contains invalid characters",
                "OK");
            return false;
        }
    ...
    {
        RequirementsTemplate entryFile = (RequirementsTemplate) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.Requirements = RPGBuilderEditorFields.DrawRequirementGroupsList(currentEntry.Requirements, true);
