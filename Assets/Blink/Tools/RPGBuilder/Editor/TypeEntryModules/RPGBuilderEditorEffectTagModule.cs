...
public class RPGBuilderEditorEffectTagModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBEffectTag> entries = new Dictionary<int, RPGBEffectTag>();
    private RPGBEffectTag currentEntry;
    ...
    {
        Dictionary<int, RPGBEffectTag> dictionary = new Dictionary<int, RPGBEffectTag>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBEffectTag>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                             AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBEffectTag>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBEffectTag entryFile = (RPGBEffectTag) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Effect Tag Name",
