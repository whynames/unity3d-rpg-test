...
public class RPGBuilderEditorActionKeyCategoryModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBActionKeyCategory> entries = new Dictionary<int, RPGBActionKeyCategory>();
    private RPGBActionKeyCategory currentEntry;
    ...
    {
        Dictionary<int, RPGBActionKeyCategory> dictionary = new Dictionary<int, RPGBActionKeyCategory>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBActionKeyCategory>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                                     AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBActionKeyCategory>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBActionKeyCategory entryFile = (RPGBActionKeyCategory) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Category Name",
