...
public class RPGBuilderEditorNodeSocketModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBNodeSocket> entries = new Dictionary<int, RPGBNodeSocket>();
    private RPGBNodeSocket currentEntry;
    ...
    {
        Dictionary<int, RPGBNodeSocket> dictionary = new Dictionary<int, RPGBNodeSocket>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBNodeSocket>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                              AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBNodeSocket>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBNodeSocket entryFile = (RPGBNodeSocket) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Node Socket Name",
