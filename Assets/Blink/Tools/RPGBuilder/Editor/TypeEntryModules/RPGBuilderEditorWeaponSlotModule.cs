...
public class RPGBuilderEditorWeaponSlotModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBWeaponSlot> entries = new Dictionary<int, RPGBWeaponSlot>();
    private RPGBWeaponSlot currentEntry;
    ...
    {
        Dictionary<int, RPGBWeaponSlot> dictionary = new Dictionary<int, RPGBWeaponSlot>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBWeaponSlot>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                              AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBWeaponSlot>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBWeaponSlot entryFile = (RPGBWeaponSlot) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Weapon Slot",
