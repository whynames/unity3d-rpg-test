...
public class RPGBuilderEditorAbilityCooldownTagModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBAbilityCooldownTag> entries = new Dictionary<int, RPGBAbilityCooldownTag>();
    private RPGBAbilityCooldownTag currentEntry;
    ...
    {
        Dictionary<int, RPGBAbilityCooldownTag> dictionary = new Dictionary<int, RPGBAbilityCooldownTag>();
        databaseEntries.Clear();
        var allEntries = Resources.LoadAll<RPGBAbilityCooldownTag>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBAbilityCooldownTag>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBAbilityCooldownTag entryFile = (RPGBAbilityCooldownTag)updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Tag Name",
