...
public class RPGBuilderEditorTextKeywordModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBTextKeyword> entries = new Dictionary<int, RPGBTextKeyword>();
    private RPGBTextKeyword currentEntry;
    ...
    {
        Dictionary<int, RPGBTextKeyword> dictionary = new Dictionary<int, RPGBTextKeyword>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBTextKeyword>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                               AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBTextKeyword>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBTextKeyword entryFile = (RPGBTextKeyword) updatedEntry;
