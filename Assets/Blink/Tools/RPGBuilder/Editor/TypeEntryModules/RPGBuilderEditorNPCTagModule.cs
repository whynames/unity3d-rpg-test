...
public class RPGBuilderEditorNPCTagModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBNPCFamily> entries = new Dictionary<int, RPGBNPCFamily>();
    private RPGBNPCFamily currentEntry;
    ...
    {
        Dictionary<int, RPGBNPCFamily> dictionary = new Dictionary<int, RPGBNPCFamily>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBNPCFamily>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                          AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBNPCFamily>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBNPCFamily entryFile = (RPGBNPCFamily) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.color = RPGBuilderEditorFields.DrawHorizontalColorField("Color", "The color used for this NPC Tag in the UI",
            RPGBuilderEditor.Instance.FieldHeight, currentEntry.color);
        currentEntry.icon = RPGBuilderEditorFields.DrawHorizontalSpriteField("Icon", "The icon used when displaying this NPC Tag in the game UI",
            RPGBuilderEditor.Instance.FieldHeight, currentEntry.icon, 100);
