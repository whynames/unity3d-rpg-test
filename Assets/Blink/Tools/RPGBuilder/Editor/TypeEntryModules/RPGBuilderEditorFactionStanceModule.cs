...
public class RPGBuilderEditorFactionStanceModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBFactionStance> entries = new Dictionary<int, RPGBFactionStance>();
    private RPGBFactionStance currentEntry;
    ...
    {
        Dictionary<int, RPGBFactionStance> dictionary = new Dictionary<int, RPGBFactionStance>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBFactionStance>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                                 AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBFactionStance>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBFactionStance entryFile = (RPGBFactionStance) updatedEntry;
