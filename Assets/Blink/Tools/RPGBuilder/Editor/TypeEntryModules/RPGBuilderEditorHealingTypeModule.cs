...
public class RPGBuilderEditorHealingTypeModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBHealingType> entries = new Dictionary<int, RPGBHealingType>();
    private RPGBHealingType currentEntry;
    ...
    {
        Dictionary<int, RPGBHealingType> dictionary = new Dictionary<int, RPGBHealingType>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBHealingType>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                               AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBHealingType>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBHealingType entryFile = (RPGBHealingType) updatedEntry;
