...
public class RPGBuilderEditorDamageTypeModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBDamageType> entries = new Dictionary<int, RPGBDamageType>();
    private RPGBDamageType currentEntry;
    ...
    {
        Dictionary<int, RPGBDamageType> dictionary = new Dictionary<int, RPGBDamageType>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBDamageType>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                              AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBDamageType>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBDamageType entryFile = (RPGBDamageType) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Damage Type Name",
        ...
        currentEntry.color = RPGBuilderEditorFields.DrawHorizontalColorField("Color", "The color used for Damage Text",
