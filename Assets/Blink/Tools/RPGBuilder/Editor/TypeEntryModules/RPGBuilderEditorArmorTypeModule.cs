...
public class RPGBuilderEditorArmorTypeModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBArmorType> entries = new Dictionary<int, RPGBArmorType>();
    private RPGBArmorType currentEntry;
    ...
    {
        Dictionary<int, RPGBArmorType> dictionary = new Dictionary<int, RPGBArmorType>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBArmorType>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                             AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBArmorType>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBArmorType entryFile = (RPGBArmorType) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Armor Type Name",
