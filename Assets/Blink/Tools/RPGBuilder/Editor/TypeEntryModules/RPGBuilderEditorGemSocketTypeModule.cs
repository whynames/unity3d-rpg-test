...
public class RPGBuilderEditorGemSocketTypeModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBGemSocketType> entries = new Dictionary<int, RPGBGemSocketType>();
    private RPGBGemSocketType currentEntry;
    ...
    {
        Dictionary<int, RPGBGemSocketType> dictionary = new Dictionary<int, RPGBGemSocketType>();
        databaseEntries.Clear();
        var allEntries = Resources.LoadAll<RPGBGemSocketType>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath + AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBGemSocketType>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBGemSocketType entryFile = (RPGBGemSocketType)updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Gem Socket Type",
