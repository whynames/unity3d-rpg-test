...
public class RPGBuilderEditorWeaponTypeModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBWeaponType> entries = new Dictionary<int, RPGBWeaponType>();
    private RPGBWeaponType currentEntry;
    ...
    {
        Dictionary<int, RPGBWeaponType> dictionary = new Dictionary<int, RPGBWeaponType>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBWeaponType>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                              AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBWeaponType>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBWeaponType entryFile = (RPGBWeaponType) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Weapon Type",
