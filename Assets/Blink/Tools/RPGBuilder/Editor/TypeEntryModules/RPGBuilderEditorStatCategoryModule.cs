...
public class RPGBuilderEditorStatCategoryModule : RPGBuilderEditorModule
{
    private Dictionary<int, RPGBStatCategory> entries = new Dictionary<int, RPGBStatCategory>();
    private RPGBStatCategory currentEntry;
    ...
    {
        Dictionary<int, RPGBStatCategory> dictionary = new Dictionary<int, RPGBStatCategory>();
        databaseEntries.Clear();
        var allEntries =
            Resources.LoadAll<RPGBStatCategory>(RPGBuilderEditor.Instance.EditorData.RPGBDatabasePath +
                                                AssetFolderName);
    ...
    public override void CreateNewEntry()
    {
        ...
        currentEntry = CreateInstance<RPGBStatCategory>();
        RPGBuilderEditor.Instance.CurrentEntry = currentEntry;
    ...
    {
        RPGBStatCategory entryFile = (RPGBStatCategory) updatedEntry;
    ...
    public override void DrawView()
    {
        ...
        currentEntry.entryName = RPGBuilderEditorFields.DrawHorizontalTextField("Stat Category Name",
